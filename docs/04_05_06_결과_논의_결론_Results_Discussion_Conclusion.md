...
셋째, 머신러닝과 SHAP 분석을 통해 지역 흡인력 결정요인의 비선형성을 규명하였다. 최우수 성능을 보인 LightGBM 모형 분석 결과, 네트워크 중심성, 인구규모와 함께 노후주택비율, 보육시설, 의료 인프라 등 생활 SOC 요인이 전통적인 경제 지표보다 인구 유입에 더 큰 영향을 미치는 것으로 나타났다. 이는 인구이동의 동기가 일자리 중심에서 '삶의 질' 중심으로 다변화되었음을 시사한다.
...
SHAP 변수 중요도 분석에서 주거 환경(노후주택비율)과 생활 SOC(의료, 보육 인프라)의 중요성이 경제 변수보다 높게 나타난 점에 주목해야 한다. 지방소멸대응기금 등 지역 균형발전 재원은 단순한 토목 공사나 일회성 현금 지원보다는, 청년층과 신혼부부가 실질적으로 체감할 수 있는 양질의 주거 환경 조성과 의료·교육 서비스 개선에 집중 투자되어야 한다.
