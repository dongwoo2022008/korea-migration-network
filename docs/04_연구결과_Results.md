...
*Note: RAI = SHAP 기여도 기반 가중 합산 지수. 가중치: Econ 0.185, Demo 0.224, Infra 0.361, Serv 0.230. **가중치는 §4.6 LightGBM SHAP 분석에서 산출된 영역별 평균 |SHAP| 기여 비중**을 적용하였다(Infra 36.1% > Serv 23.0% > Demo 22.4% > Econ 18.5%). 분석 기간: 2017~2024년 패널 평균. N=229개 시군구.*
