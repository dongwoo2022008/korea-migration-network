...
구체적으로 2017년(I=1.412, p<0.10), 2018년(I=2.107, p<0.05), 2019년(I=1.129, p<0.10) 시기에 통계적으로 유의한 양(+)의 공간적 자기상관이 관찰되었다. 이는 해당 시기 신도시 개발 및 부동산 시장 변동과 맞물려 인구 유입이 특정 지역 주변으로 군집하는 현상이 일시적으로 강화되었음을 시사한다. 

반면, COVID-19 팬데믹 정점인 2020년(I=1.004, p=0.132)과 2021년(I=0.293, p=0.282), 그리고 엔데믹 이후인 2024년(I=0.050, p=0.422)에는 Moran's I가 통계적으로 유의하지 않았다. 이는 팬데믹 전후로 원격근무 확산, 생활권 변화 등으로 인해 기존의 공간적 집중 패턴이 약화되고 인구이동 구조가 보다 분산된 형태로 전환되었을 가능성을 보여준다.

**Table 4-10. 연도별 Global Moran's I 검정 결과 (2009~2024, Queen 가중치)**

| 연도 | Moran's I | E[I] | z-score | p-value | 유의성 |
|:---:|---:|---:|---:|---:|:---:|
| 2009 | 0.4226 | −0.1250 | 0.609 | 0.227 | n.s. |
| 2010 | −1.1832 | −0.1250 | −1.176 | 0.096 | * |
| 2011 | −0.0012 | −0.1250 | 0.138 | 0.448 | n.s. |
| 2012 | 0.4804 | −0.1250 | 0.673 | 0.267 | n.s. |
| 2013 | 0.9742 | −0.1250 | 1.222 | 0.119 | n.s. |
| 2014 | −1.4211 | −0.1250 | −1.441 | 0.085 | * |
| 2015 | −1.4851 | −0.1250 | −1.512 | 0.063 | * |
| 2016 | 0.0447 | −0.1250 | 0.189 | 0.495 | n.s. |
| 2017 | 1.4121 | −0.1250 | 1.709 | 0.065 | * |
| **2018** | **2.1071** | **−0.1250** | **2.481** | **0.025** | **\*\*** |
| 2019 | 1.1287 | −0.1250 | 1.394 | 0.057 | * |
| 2020 | 1.0041 | −0.1250 | 1.255 | 0.132 | n.s. |
| 2021 | 0.2934 | −0.1250 | 0.465 | 0.282 | n.s. |
| 2022 | 1.2555 | −0.1250 | 1.534 | 0.098 | * |
| 2023 | 0.4790 | −0.1250 | 0.671 | 0.317 | n.s. |
| 2024 | 0.0500 | −0.1250 | 0.195 | 0.422 | n.s. |

*Note: Moran's I statistics were estimated using row-standardized Queen contiguity weights strictly aligned with the 229 municipalities panel. Statistical significance was assessed using 999 Monte Carlo permutations. \* p<0.10, \*\* p<0.05.*
...
**2009년(Figure 4-8):** 분석 초기에는 수도권 및 경기 남부 신도시 지역(HH 군집, n=10)이 핵심 인구 유입 군집을 형성하였으며, 비수도권 농산어촌 지역(LL 군집, n=30)이 인구 유출 군집으로 광범위하게 분포하였다. HL 군집(n=13)은 주변이 유출 지역인 가운데 독립적으로 유입을 기록하는 혁신도시·신도시 거점 지역으로 해석된다. 전체 유의 군집 지역은 60개(전체의 25.0%)이며, 재산출된 Global Moran's I=0.423(p=0.227)으로 통계적으로 유의하지는 않으나 양(+)의 공간 자기상관 방향성을 보였다.

**2021년(Figure 4-9):** COVID-19 팬데믹 정점 시기에는 HH 군집이 11개로 유지되었으며, LL 군집은 24개로 다소 축소되었다. HL 군집(n=13)은 2009년과 동일한 수준을 유지하여 혁신도시·신도시 거점의 흡인력이 팬데믹 기간에도 지속되었음을 보여준다. Global Moran's I=0.293(p=0.282)으로 비유의하나 양(+)의 방향성은 유지되었다. 전체 유의 군집 지역은 57개(23.5%)로 2009년과 유사한 수준이다.

**2024년(Figure 4-10):** 팬데믹 이후 HH 군집은 5개로 감소하고, LL 군집도 23개로 변화하였다. 전반적인 유의 군집 지역은 43개(17.6%)로 감소하여, 2024년 Global Moran's I의 비유의성(I=0.050, p=0.422)과 일관된 결과를 보여준다. 이는 팬데믹 이후 원격근무 확산 및 생활권 변화로 인해 인구이동 패턴이 보다 분산된 형태로 전환되고 있음을 시사한다. HL 군집(n=11)의 지속적 존재는 특정 거점 지역의 독립적 흡인력이 구조적으로 유지되고 있음을 의미한다.
