...
특히 주목할 점은 허브의 안정성(Hub Stability)이다. 2008년 상위 20개 허브와의 연도별 Jaccard 유사도는 지속적으로 하락하였으며, 상세 수치와 시계열은 §4.2.6(Figure 4-11, Table 4-5)에서 상세히 다룬다. 이는 기존 전통적 거점(예: 지방 광역시 중심구)들이 쇠퇴하고, 혁신도시 및 2기/3기 신도시를 품은 새로운 지역들이 새로운 허브로 부상하는 동태적 재편 과정이 활발히 일어났음을 시사한다.
