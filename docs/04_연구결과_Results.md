...
| … | … | … | … | … | … | … | … | … |
| 219 | 해남군 | 전라남도 | -0.600 | 0.031 | -0.472 | -1.314 | -0.111 | -12.26 |
| 220 | 의성군 | 경상북도 | -0.615 | -0.056 | -0.799 | -1.019 | -0.250 | 2.78 |
| 221 | 임실군 | 전북특별자치도 | -0.624 | -0.255 | -0.550 | -1.282 | 0.044 | -10.30 |
| 222 | 고성군 | 경상남도 | -0.634 | -0.308 | -0.471 | -1.306 | 0.002 | -4.98 |
| 223 | 합천군 | 경상남도 | -0.635 | -0.341 | -0.733 | -1.125 | -0.003 | -5.89 |
| 224 | 울릉군 | 경상북도 | -0.641 | 0.579 | -0.224 | -1.217 | -1.125 | -5.77 |
| 225 | 영양군 | 경상북도 | -0.647 | -0.160 | -0.666 | -1.230 | -0.106 | -4.03 |
| 226 | 청도군 | 경상북도 | -0.710 | -0.078 | -0.684 | -1.315 | -0.296 | 4.24 |
| 227 | 영덕군 | 경상북도 | -0.712 | -0.592 | -0.670 | -0.993 | -0.406 | -6.95 |
| 228 | 의령군 | 경상남도 | -0.755 | -0.265 | -0.631 | -1.513 | -0.076 | 0.31 |
...
### 4.8.3-b RAI 내적 타당성 검증 (Cronbach's α · PCA)
...
Figure 4-19는 상위 10개 지역과 하위 10개 지역의 하위지수 구성을 비교한 것이다. 상위 지역은 인프라(Infra) 점수가 가장 높고(평균 1.36), 경제(Econ, 1.31)·서비스(Serv, 0.73)·인구(Demo, 0.47) 순으로 나타났다. 하위 지역은 인프라(-1.22)와 인구(-0.59) 부문에서 특히 낮은 점수를 보여, **인프라 격차**가 지역 흡인력 양극화의 핵심 요인임을 확인하였다. 이는 §4.6의 SHAP 분석에서 인프라 관련 변수(house_age, childcare_pk)가 상위 변수로 도출된 결과와 일관된다.

### 4.8.5 소결

본 절의 분석 결과를 종합하면, 지역 흡인력 지수(RAI)는 수도권-비수도권 간 구조적 격차를 정량적으로 포착하며, 인프라 부문이 흡인력 양극화의 주요 동인임을 확인하였다. RAI-순이동률 상관(지역 평균 r=0.208, 패널 r=0.144)이 중간 수준에 그치는 것은 RAI가 단기 이동 패턴이 아닌 장기적 지역 경쟁력을 측정하는 지표임을 반영하며, 이는 선행연구(Niedomysl, 2010; Haase et al., 2021)의 보고 범위(0.2~0.4)와 일치한다. 이는 지역 정책 수립 시 단기 인구 유출입보다 **구조적 매력도 개선**에 초점을 맞출 필요성을 시사한다.
