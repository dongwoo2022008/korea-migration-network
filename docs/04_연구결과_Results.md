...
![Figure 4-4. Annual Change in Network Concentration (HHI)](https://raw.githubusercontent.com/dongwoo2022008/korea-migration-network/main/results/figures/fig4_06_hhi_concentration_trend.png)
...
![Figure 4-5. Annual Change in Freeman Centralization](https://raw.githubusercontent.com/dongwoo2022008/korea-migration-network/main/results/figures/fig4_07_freeman_centralization_trend.png)
...
![Figure 4-6. Louvain Community Detection Map (2008)](https://raw.githubusercontent.com/dongwoo2022008/korea-migration-network/main/results/figures/fig4_04_louvain_community_2008.png)
...
![Figure 4-7. Louvain Community Detection Map (2025)](https://raw.githubusercontent.com/dongwoo2022008/korea-migration-network/main/results/figures/fig4_05_louvain_community_2025.png)
...
![Figure 4-9. LISA 군집 지도 (2008)](https://raw.githubusercontent.com/dongwoo2022008/korea-migration-network/main/results/figures/fig4_10_lisa_cluster_2025.png)

![Figure 4-10. LISA 군집 지도 (2025)](https://raw.githubusercontent.com/dongwoo2022008/korea-migration-network/main/results/figures/fig4_09_lisa_cluster_2008.png)
...
RAI와 순이동률 간의 Pearson 상관계수는 지역 평균(N=228) 기준 r=0.208 (p=0.002)로 통계적으로 유의한 양(+)의 관계를 확인하였으며, 패널 전체(N=1,824) 기준으로도 r=0.144 (p<0.001)로 일관되게 유의하였다. 상관 크기가 중간 수준에 그치는 것은 RAI가 **구조적 매력도(장기 평균)**를 측정하는 반면, 순이동률은 **단기 변동성**(신도시 입주, 재개발, 행정구역 개편 등 일시적 요인)에 크게 영향받기 때문이다. 실제로 화성시(RAI 2위, 순이동률 +45.26‰)와 같이 RAI와 이동률이 일치하는 지역이 있는 반면, 강남구(RAI 5위, 순이동률 -2.48‰)처럼 구조적 매력도와 실제 이동 방향이 분리되는 지역도 다수 존재한다. 이는 RAI가 단기 이동률이 아닌 **장기적 지역 경쟁력**을 측정하는 지표임을 시사하며, 선행연구(Niedomysl, 2010; Haase et al., 2021)에서도 매력도 지수와 이동률 간 상관이 0.2~0.4 수준임을 보고한 바 있다.
