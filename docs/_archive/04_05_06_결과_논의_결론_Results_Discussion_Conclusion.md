...
셋째, 머신러닝과 SHAP 분석을 통해 지역 흡인력 결정요인의 비선형성을 규명하였다. SHAP 분석 결과, **노후주택비율(1위)과 네트워크 중심성(2위)**을 시작으로 보육시설·의료 인프라 등 생활 SOC 요인이 전통적인 경제 지표보다 인구 유입에 더 큰 영향을 미치는 것으로 나타났다. 특히 노후주택비율이 최상위 결정요인으로 나타난 것은 주거환경의 물리적 쾌적성이 네트워크 허브 지위에 버금가는 인구 흡인의 핵심 동인임을 의미하며, 인구이동의 동기가 일자리 중심에서 '삶의 질' 중심으로 다변화되었음을 시사한다.
