...
df = pd.read_csv('/home/ubuntu/capstone/analysis_dataset_FINAL_v4.csv')
...
df.to_csv('/home/ubuntu/capstone/analysis_dataset_preprocessed.csv', index=False, encoding='utf-8-sig')
...
track_a.to_csv('/home/ubuntu/capstone/track_A_2008_2025.csv', index=False, encoding='utf-8-sig')
...
track_b_clean.to_csv('/home/ubuntu/capstone/track_B_2009_2024.csv', index=False, encoding='utf-8-sig')
...
track_c.to_csv('/home/ubuntu/capstone/track_C_2017_2024.csv', index=False, encoding='utf-8-sig')
